...
// message board routes ===============================================================
    ...
    app.post('/messages', (req, res) => {
      db.collection('messages').save({order: req.body.order, size: req.body.size, customer: req.body.customer}, (err, result) => {
        if (err) return console.log(err)
    ...
    app.delete('/messages', (req, res) => {
      db.collection('messages').findOneAndDelete({order: req.body.order, size: req.body.size, customer: req.body.customer}, (err, result) => {
